// Source: https://stackoverflow.com/questions/26574326/how-to-calculate-the-level-amplitude-db-of-audio-signal-in-java
    ...
    static class Recorder implements Runnable {
        ...
        public void run() {
            ...
            for(int b; (b = line.read(buf, 0, buf.length)) > -1;) {
                ...
                rms = (float)Math.sqrt(rms / (samples.length / 2));
                ...
                lastPeak = peak;
                System.out.println(20 * (float)Math.log10(rms));
